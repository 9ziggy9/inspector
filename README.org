...
- [ ] Please implement backoff algorithm for nominatim searching, limit 1 req per 2 seconds.
- [ ] Indicate when no cache is available so users don't pull their hair out.
